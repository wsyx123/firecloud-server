...
from views import Kubernetes,K8sOverview,K8sDetail
#idle host
from views import MesosIdleHostAdd,MesosIdleHostList,MesosIdleHostDelete
#mesos class
from views import MesosClusterList,MesosOverview,MesosAddCluster,MesosAddNode,ListNetwork,\
...
#mesos func
from views import cluster_node_update,cluster_node_log

from repository import RepositoryHostList,RepositoryImageList,\
