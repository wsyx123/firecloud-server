# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2018-10-31 01:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=32, verbose_name='\u6a21\u7248\u540d')),
                ('type', models.IntegerField(choices=[(1, 'playbook')], verbose_name='\u7c7b\u578b')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('function', models.CharField(max_length=64, verbose_name='\u4efb\u52a1\u51fd\u6570')),
                ('execute_time', models.CharField(max_length=32, verbose_name='\u6267\u884c\u65f6\u95f4')),
                ('status', models.CharField(max_length=5, verbose_name='\u72b6\u6001')),
                ('notification_type', models.IntegerField(choices=[(1, 'email'), (2, 'sms')], verbose_name='\u901a\u77e5\u7c7b\u578b')),
                ('receive_info', models.CharField(max_length=64, verbose_name='\u63a5\u6536\u4eba')),
                ('hosts', models.ManyToManyField(to='webapp.AssetHost', verbose_name='\u4e3b\u673a')),
            ],
        ),
        migrations.CreateModel(
            name='Enterprise',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('groupname', models.CharField(max_length=32, verbose_name='\u4e3b\u673a\u7ec4')),
                ('host_number', models.IntegerField(verbose_name='\u4e3b\u673a\u6570\u91cf')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('modify_time', models.DateTimeField(auto_now_add=True, verbose_name='\u53d8\u66f4\u65f6\u95f4')),
                ('modify_content', models.CharField(max_length=64, verbose_name='\u53d8\u66f4\u5185\u5bb9')),
                ('assert_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapp.AssetHost', verbose_name='\u8d44\u4ea7\u53f7')),
            ],
        ),
        migrations.CreateModel(
            name='Level1Menu',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapp.SysRole')),
            ],
        ),
        migrations.CreateModel(
            name='TaskDetail',
            fields=[
                ...
                ('output', models.TextField(verbose_name='\u8f93\u51fa\u5185\u5bb9')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_type', models.CharField(max_length=32, verbose_name='\u7c7b\u578b')),
        ...
        migrations.AddField(
            ...
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapp.SysUser', verbose_name='\u521b\u5efa\u4eba'),
        ),
        migrations.AddField(
            model_name='assethost',
            name='group',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='webapp.HostGroup', verbose_name='\u4e3b\u673a\u7ec4'),
        ),
        migrations.AddField(
