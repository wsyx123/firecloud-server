...
import traceback
import requests
from asset.models import HostImport,AssetHost,HostEvent,HostDisk,HostEth
from paas.models import MesosMaster,MesosNodeStatus,MesosMarathon,MesosHaproxy,MesosSlave,MesosDeployLog
...
def collect_host_info_task(asset_id,private_ip,port,user,password,action_num):
    ...
    if collect_result['status'] == 'ok':
        ...
        queryset.verdor = collect_result['result']['vendor']
        queryset.save()
